...
# wget -nv "https://github.com/Dao-AILab/flash-attention/releases/download/v2.7.4.post1/${FLASH_ATTN_WHL}" && \
...
# FLASHINFER_WHL="flashinfer_python-0.2.2.post1+cu124torch2.6-cp38-abi3-linux_x86_64.whl"
# wget -nv "https://github.com/flashinfer-ai/flashinfer/releases/download/v0.2.2.post1/${FLASHINFER_WHL}" && \
#     pip install --no-cache-dir "${FLASHINFER_WHL}" && \
#     rm -f "${FLASHINFER_WHL}"
